...
export default function UsersByRoleSummary({ usersByRole }: UsersByRoleSummaryProps) {
  ...
  return (
    <div className="bg-paper-cream border border-graphite-border rounded-lg p-6 flex flex-col h-full">
      ...
      <div className="grid grid-cols-2 gap-4 flex-grow items-center">
        <div className="bg-white border border-graphite-border rounded p-4 text-center">
